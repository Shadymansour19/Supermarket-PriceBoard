 ...
 * deal push notifications. No `.select()` on the way back — the public
 * insert policy is intentionally write-only, so subscriber endpoints are
 * never readable by anon clients. */
