  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        noCategories: "No categories yet — add your first one above.",
        ...
        noSubcategory: "No subcategory (general)",
  ...
  ar: {
    translation: {
      ...
      favorites: {
        navLabel: "المفضلة",
        title: "المفضلة لديك",
        empty: "لسه مفيش حاجة في المفضلة... دوس على ♡ في أي منتج عجبك!",
      ...
      admin: {
        ...
        active: "ظاهر للعملاء",
        hidden: "مخفي",
        noProducts: "لا توجد منتجات بعد — أضف أول منتج بالأعلى.",
        noCategories: "لا توجد أقسام بعد — أضف أول قسم بالأعلى.",
        searchProducts: "ابحث عن منتج…",
        searchCategories: "ابحث عن قسم…",
        noSearchResults: "لا توجد نتائج مطابقة لبحثك.",
        parentCategory: "القسم الرئيسي",
        topLevel: "— قسم رئيسي —",
        subcategory: "القسم الفرعي",
        noSubcategory: "بدون قسم فرعي (عام)",
